...
class CustomLoggerWrapper():
    ...
    def __init__(self, logger_name, logger_level=logging.INFO, logger_propagate=False, logger_fmt="%(asctime)s - %(levelname)s - %(message)s", log_filename="mylog.log"):
    ...
    def InitLogger(self):
        ...
        self.custom_logger.setLevel(level=logging.INFO)
